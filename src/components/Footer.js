	...
	<footer className="text-center mt-12 bg-black dark:bg-gray-900 px-10">
		<div className="text-sm my-8 py-4 text-center text-gray-400 flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
			...
			<div className="flex flex-row space-x-3">
				...
				<a href="https://twitter.com/tryShowtime" target="_blank" className="hover:text-gray-300 transition">
				...
				<a href="https://www.instagram.com/tryshowtime/" target="_blank" className="hover:text-gray-300 transition">
				...
				<a href="https://discord.gg/FBSxXrcnsm" target="_blank" className="hover:text-gray-300 transition">
					<svg aria-hidden="true" className="w-5 h-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
						<path
							fill="currentColor"
			...
			<div>
				<a href="https://www.notion.so/Showtime-Legal-c407e36eb7cd414ca190245ca8621e68" target="_blank" className="hover:text-gray-300 transition">
					Terms &amp; Conditions
				</a>{' '}
				· <span className="cursor-pointer hover:text-gray-300 transition">Feedback</span>
			</div>
		</div>
	</footer>
)
