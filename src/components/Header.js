			...
			<div className="flex items-center">
				<div className="hidden md:flex mr-6 items-center space-x-6" style={{ fontWeight: 400 }}>
					...
					<div className="flex-shrink ml-5">
						<button className="relative hover:text-stpink border-gray-900 dark:border-gray-800 hover:border-stpink dark:hover:border-stpink border-2 rounded-full h-9 w-9 flex items-center justify-center cursor-pointer relative group transition">
